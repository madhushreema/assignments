...
create proc check2 (@id varchar(100) ,@password varchar(100))
as
select customerid,customerpassword from tbl_customerinfo
if(@id=customerid and @password=customerpassword)
begin
return 1
end
else
