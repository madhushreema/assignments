...
create proc proc_addAccount(@CustomerID int,@CustomerBalance int ,@type varchar(100),@date datetime)
  ...
  create proc proc_AddBooks1(@BookName varchar(100),@AuthorName varchar(100),@BookImage varchar(100))
  as
  ...
  as
  insert tbl_IssueBooks values(@BookID,@StudentID,'Issued',GETDATE())
  return @@identity
